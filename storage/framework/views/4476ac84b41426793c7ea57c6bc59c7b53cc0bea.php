<head>
    ...
    <title><?php echo e(Settings()->portal_name); ?>-<?php echo $__env->yieldContent('title'); ?></title>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('assets/bundles/jquery-ui/jquery-ui.min.css')); ?>">
  ...
  <link rel='shortcut icon' type='image/x-icon' href="<?php echo e(url('public/img/settings/'.Settings()->portal_favicon)); ?>" />
</head><?php /**PATH E:\system\xampp8.1\htdocs\aik-boond\resources\views/layouts/head.blade.php ENDPATH**/ ?>